...
async def terms_of_service():
    return HTMLResponse("""<!DOCTYPE html><html><head><title>Travelioo - Conditions Generales</title>
...
<h2>1. Objet</h2>
<p>Travelioo est un service de reservation de billets d'avion accessible via WhatsApp. En utilisant le service, vous acceptez les presentes conditions.</p>

<h2>2. Inscription</h2>
<p>L'utilisation de Travelioo necessite un numero WhatsApp valide. Vous devez fournir des informations exactes lors de l'inscription (nom, passeport).</p>

<h2>3. Reservations</h2>
<p>Les vols proposes proviennent de nos partenaires aeriens via Duffel. Les prix incluent une commission Travelioo de 15EUR par billet. Les tarifs sont affiches en EUR et XOF.</p>
...
<p>Les conditions d'annulation dependent du type de billet (Budget, Standard, Flex). Les frais Travelioo (15EUR) ne sont pas remboursables. Les remboursements sont traites sous 3 a 10 jours ouvres.</p>

<h2>6. Responsabilite</h2>
<p>Travelioo agit en tant qu'intermediaire entre le voyageur et les compagnies aeriennes. Nous ne sommes pas responsables des annulations, retards ou modifications effectuees par les compagnies.</p>
...
<h2>8. Contact</h2>
<p>support@travelioo.app</p>
</body></html>""")


@router.get("/privacy")
async def privacy_policy():
    return HTMLResponse("""<!DOCTYPE html><html><head><title>Travelioo - Politique de Confidentialite</title>
<meta name="viewport" content="width=device-width,initial-scale=1">
<style>body{font-family:sans-serif;max-width:700px;margin:40px auto;padding:20px;line-height:1.6;color:#333}
...
<h2>6. Vos Droits</h2>
<p>Conformement au RGPD, vous pouvez demander l'acces, la rectification ou la suppression de vos donnees en contactant support@travelioo.app.</p>
