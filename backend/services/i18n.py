...
MESSAGES = {
    ...
    "returning_user": {
        ...
        "pt": "Ola novamente {name}!\nVoce esta reservando para si ou para outra pessoa?\n\n*1* Para mim ({fullname})\n*2* Para outra pessoa",
    },
}
